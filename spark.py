...
os.environ["SPARK_HOME"] = "/workspaces/projet-esme-kafka2/spark-3.2.3-bin-hadoop2.7"
...
processed_df = processed_df.withColumn(
    ...
    col("temperature") + (0.5555 * (
        (6.11 * (10 ** ((7.5 * col("temperature")) / (237.7 + col("temperature")))) * (col("humidity") / 100)) - 10
    ))
)
